                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('chatai.pdf.delete', $doc->id) }}" method="POST" class="d-inline delete-pdf-form">
                                                    @csrf
                                                    @method('DELETE')
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Select all forms with class 'delete-pdf-form'
        const deleteForms = document.querySelectorAll('.delete-pdf-form');
