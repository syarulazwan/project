            ...
            <div class="">
                <nav>
                    <ol class="breadcrumb mb-0" style="--bs-breadcrumb-divider: '/'; color: rgb(0, 0, 0);">
                        ...
                        <li class="breadcrumb-item active mb-0 fw-semibold">List of Project</li>
                        <li class="breadcrumb-item active mb-0 fw-semibold" aria-current="page">Project</li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <div class="p-xl-5 p-2 z-1">
                                <div class="p-4 bg-black-transparent rounded-3 border border-opacity-10 border-white">
                                    <div class="d-flex gap-3 align-items-center flex-wrap">
                                       <div>
                                            <h4 class="text-fixed-white mb-1">{{ $project->name ?? '-' }}</h4>
                                            ...
                                            <p class="mb-1 op-6 fs-15">
                                                <i class="ri-calendar-line lh-1 align-middle me-2 d-inline-block"></i>
                    ...
                    <div class="card-body">
                        <div class="wizard-container">
                            <div class="wizard-sidebar">
                                <ol id="steps">
                                <li class="current" data-step="0"><span>1</span> Project Information</li>
                                <li data-step="1"><span>2</span> Project Member</li>
                                <li data-step="2"><span>3</span> Project Location</li>
                                </ol>
                            </div>
                            <div class="wizard-form">
                                    <div class="step current">
                                        @include('pages.project.list-project.step.step-1-project-information')
                                    </div>
                                    <div class="step">
                                        @include('pages.project.list-project.step.step-2-project-member')
                                    </div>
                                    <div class="step">
                                         @include('pages.project.list-project.step.step-3-project-location')
                                    </div>
