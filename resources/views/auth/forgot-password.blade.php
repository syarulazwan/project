                                ...
                                <form method="POST" action="{{ route('forgot') }}">
                                    ...
                                    <div class="row gy-3">
                                        <div class="col-xl-12 mt-2">
                                            <label class="form-label text-default" for="forgot-email">Email Address<sup class="fs-12 text-danger">*</sup></label>
                                            <input class="form-control forgot-email-input @error('email') is-invalid @enderror" id="forgot-email" placeholder="Enter your email address" type="email" name="email" value="{{ old('email', session('email_value')) }}"> 
                                            <div>
                                                @error('email')
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="input-group"> 
                                                <input class="form-control newpassword-password-input @error('password') is-invalid @enderror" id="newpassword-password" placeholder="Enter a new password" type="password" name="password" value="{{ old('password', session('password_value')) }}"> 
                                        ...
                                        <div class="col-xl-12 mb-2">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control create-password-input @error('password_confirmation') is-invalid @enderror" id="create-confirmpassword" placeholder="Re-enter your new password" type="password" name="password_confirmation" value="{{ old('password_confirmation', session('password_confirmation_value')) }}"> 
                                    ...
                                    <div class="d-grid mt-4">
                                         <button type="submit" class="btn btn-primary">
                                            <i class="ri-login-circle-line lh-1 me-2 align-middle"></i>Reset Password
                                        </button>
                                    </div>
                                </form>
                                <div class="text-center">
                                    <p class="text-muted mt-3 mb-0">Want to go back? <a class="text-primary fw-medium text-decoration-underline" href="{{ route('login.form') }}">Click here</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
